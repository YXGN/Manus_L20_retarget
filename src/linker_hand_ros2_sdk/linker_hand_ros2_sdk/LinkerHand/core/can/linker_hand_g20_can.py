...
class LinkerHandG20Can:
    ...
    def send_command(self, frame_property, data_list, sleep_time=None):
        """
        发送指令到CAN总线
        ...
        time.sleep(self.command_sleep_time if sleep_time is None else sleep_time)
    ...
    def get_touch_sensor_type(self):
        ...
        if isinstance(self.xB0, (list, tuple)):
            return self.xB0[0] if self.xB0 else 0
        if isinstance(self.xB0, (int, float)):
            return int(self.xB0)
        return 0
