...
from l20_ik_core.core import BiHandFrame, BiHandSourceFrame, HandFrame, SourceFrame, normalize_hand_side
from l20_ik_core.domain.hand_detection import HandDetection
from l20_ik_core.hc_mocap_input import _DirectHCMocapUDPProvider, create_hc_mocap_udp_provider, hc_mocap_frame_to_landmarks
from l20_ik_core.pico_input import PicoBridgeReceiver, create_pico_provider, pico_frame_to_detection
...
def _load_hand_detector_cls():
    ...
    if HandDetector is None:
        from l20_ik_core.hand_detector import HandDetector as detector_cls
    ...
    def _start_pipeline(
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError(
                "RealSense input requires pyrealsense2. Install it in the l20_ik_core conda env, "
