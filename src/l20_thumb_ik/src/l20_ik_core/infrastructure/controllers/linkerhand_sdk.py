...
from l20_ik_core.domain import HandCommand, HandState
from l20_ik_core.infrastructure.controllers.adapters import LinkerHandModelAdapter
from l20_ik_core.infrastructure.controllers.l20_flexion_calibration import L20FlexionCommandCalibrator
from l20_ik_core.infrastructure.controllers.l20_joint_range_mapping import L20JointRangeCommandMapper
...
def _load_linkerhand_api_class(sdk_root: str):
    ...
    spec = importlib.util.spec_from_file_location("l20_ik_core_linkerhand_api", module_path)
